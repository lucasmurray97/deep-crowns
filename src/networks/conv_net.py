...
class Conv_Net(nn.Module):
    def __init__(self, params = {}):
        ...
        self.name = "Conv-Net"
        self.conv1 = nn.Conv2d(in_channels=9, out_channels=16, kernel_size=(2,2), stride=(1,1)) # (64, 10, 10)
        ...
        self.conv4 = nn.Conv2d(in_channels=64, out_channels=96, kernel_size=(2,2), stride=(1,1)) # (64, 10, 10)
        self.bn4_ = nn.BatchNorm2d(96)
        self.max_pool_4_= nn.MaxPool2d(2)
        self.conv5 = nn.Conv2d(in_channels=96, out_channels=128, kernel_size=(2,2), stride=(1,1)) # (64, 10, 10)
        self.bn5_ = nn.BatchNorm2d(128)
        self.max_pool_5_= nn.MaxPool2d(2)
        self.fci_1 = nn.Linear(in_features=4480, out_features=1024)
