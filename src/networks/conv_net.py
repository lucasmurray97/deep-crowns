...
class Conv_Net(nn.Module):
    def __init__(self, params = {}):
        ...
        self.conv5 = nn.Conv2d(in_channels=256, out_channels=256, kernel_size=(2,2), stride=(1,1)) # (64, 10, 10)
        self.bn5_ = nn.BatchNorm2d(256)
        self.max_pool_5_= nn.MaxPool2d(2)
        self.conv6 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=(2,2), stride=(1,1)) # (64, 10, 10)
        self.bn6_ = nn.BatchNorm2d(512)
        self.max_pool_6_= nn.MaxPool2d(2)
        self.fci_1 = nn.Linear(in_features=7680, out_features=1024)
