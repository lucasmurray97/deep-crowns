...
class Conv_Net(nn.Module):
    def __init__(self, params = {}):
        ...
        self.name = "Conv-Net"
        self.conv1 = nn.Conv2d(in_channels=9, out_channels=32, kernel_size=(3,3), stride=(2,2)) # (64, 10, 10)
        self.bn1 = nn.BatchNorm2d(32)
        self.max_pool_1 = nn.MaxPool2d(3)
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=(3,3), stride=(2,2)) # (64, 10, 10)
        self.bn2 = nn.BatchNorm2d(32)
        self.max_pool_2 = nn.MaxPool2d(3)
        self.fci_1 = nn.Linear(in_features=2560, out_features=1024)
