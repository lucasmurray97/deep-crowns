...
class Conv_Net2(nn.Module):
    def __init__(self, params = {}):
        ...
        self.conv1_ = nn.ConvTranspose2d(in_channels=256, out_channels=128, kernel_size=(2,2), stride=(3,3))
        self.bn9 = nn.BatchNorm2d(128)
        self.conv2_ = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=(3,3), stride=(3,3))
        self.bn10 = nn.BatchNorm2d(64)
        self.conv3_ = nn.ConvTranspose2d(in_channels=64, out_channels=32, kernel_size=(3,3), stride=(3,3))
        self.bn11 = nn.BatchNorm2d(32)
        self.conv4_ = nn.ConvTranspose2d(in_channels=32, out_channels=16, kernel_size=(3,3), stride=(2,2))
        self.bn12 = nn.BatchNorm2d(16)
        self.conv5_ = nn.ConvTranspose2d(in_channels=16, out_channels=1, kernel_size=(4,4), stride=(2,2))
        self.loss = []
        self.epoch_loss = 0
        self.val_loss = []
