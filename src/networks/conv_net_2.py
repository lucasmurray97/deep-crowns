...
class Conv_Net2(nn.Module):
    def __init__(self, params = {}):
        ...
        self.conv6 = nn.Conv2d(in_channels=512, out_channels=2048, kernel_size=(3,3), stride=(1,1)) # (64, 10, 10)
        ...
        self.conv1_ = nn.ConvTranspose2d(in_channels=2049, out_channels=512, kernel_size=(4,4), stride=(2,2))
