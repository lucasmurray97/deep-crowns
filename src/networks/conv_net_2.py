...
class Conv_Net2(nn.Module):
    def __init__(self, params = {}):
        ...
        self.name = "Conv-Net2"
        self.conv1 = nn.Conv2d(in_channels=9, out_channels=16, kernel_size=(3,3), stride=(1,1)) # (64, 10, 10)
        self.bn1 = nn.BatchNorm2d(16)
        self.max_pool_1 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=(3,3), stride=(1,1)) # (64, 10, 10)
        self.bn2 = nn.BatchNorm2d(32)
        self.max_pool_2 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv3 = nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(3,3), stride=(1,1)) # (64, 10, 10)
        self.bn3 = nn.BatchNorm2d(64)
        self.max_pool_3 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv4 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(3,3), stride=(1,1)) # (64, 10, 10)
        self.bn4_ = nn.BatchNorm2d(128)
        self.max_pool_4_= nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv5 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(3,3), stride=(1,1)) # (64, 10, 10)
        self.bn5_ = nn.BatchNorm2d(256)
        self.max_pool_5_= nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv6 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=(3,3), stride=(1,1)) # (64, 10, 10)
        ...
        self.fc_1 = nn.Linear(in_features=8208, out_features=4608)
        self.bn7 = nn.BatchNorm1d(4608)
        self.conv1_ = nn.ConvTranspose2d(in_channels=512, out_channels=256, kernel_size=(2,2), stride=(3,3))
        self.bn9 = nn.BatchNorm2d(256)
        self.conv2_ = nn.ConvTranspose2d(in_channels=256, out_channels=128, kernel_size=(3,3), stride=(3,3))
        self.bn10 = nn.BatchNorm2d(128)
        self.conv3_ = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=(3,3), stride=(2,2))
        self.bn11 = nn.BatchNorm2d(64)
        self.conv4_ = nn.ConvTranspose2d(in_channels=64, out_channels=32, kernel_size=(3,3), stride=(2,2))
        self.bn12 = nn.BatchNorm2d(32)
        self.conv5_ = nn.ConvTranspose2d(in_channels=32, out_channels=16, kernel_size=(3,3), stride=(2,2))
        self.bn13 = nn.BatchNorm2d(16)
        self.conv6_ = nn.ConvTranspose2d(in_channels=16, out_channels=1, kernel_size=(4,4), stride=(2,2))
        self.loss = []
        self.epoch_loss = 0
        self.val_loss = []
