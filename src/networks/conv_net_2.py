...
class Conv_Net2(nn.Module):
    def __init__(self, params = {}):
        ...
        self.conv1_ = nn.ConvTranspose2d(in_channels=513, out_channels=256, kernel_size=(4,4), stride=(2,2))
        self.bn9 = nn.BatchNorm2d(256)
        self.conv2_ = nn.ConvTranspose2d(in_channels=256, out_channels=128, kernel_size=(5,5), stride=(2,2))
        self.bn10 = nn.BatchNorm2d(128)
        self.conv3_ = nn.ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=(4,4), stride=(2,2))
        self.bn11 = nn.BatchNorm2d(64)
        self.conv4_ = nn.ConvTranspose2d(in_channels=64, out_channels=32, kernel_size=(4,4), stride=(2,2))
        self.bn12 = nn.BatchNorm2d(32)
        self.conv5_ = nn.ConvTranspose2d(in_channels=32, out_channels=16, kernel_size=(5,5), stride=(2,2))
