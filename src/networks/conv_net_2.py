...
class Conv_Net2(nn.Module):
    def __init__(self, params = {}):
        ...
        self.fc_1 = nn.Linear(in_features=8208, out_features=2048)
        self.bn7 = nn.BatchNorm1d(2048)
        self.conv1_ = nn.ConvTranspose2d(in_channels=512, out_channels=256, kernel_size=(4,4), stride=(4,4))
        self.bn9 = nn.BatchNorm2d(256)
        self.conv2_ = nn.ConvTranspose2d(in_channels=256, out_channels=128, kernel_size=(4,4), stride=(3,3))
